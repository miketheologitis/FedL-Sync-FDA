...
if __name__ == '__main__':
    ...
    for sim_id in range(args.n_sims):
        ...
        with open(f'FdAvg/tmp/local_out/c{args.comb_file_id}_sim{sim_id}.out', 'w') as stdout_file:
            with open(f'FdAvg/tmp/local_out/c{args.comb_file_id}_sim{sim_id}.err', 'w') as stderr_file:
