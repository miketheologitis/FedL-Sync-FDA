...
CIFAR10_CNN_BATCH_INPUT = (None, 32, 32, 3)  # CIFAR-10 dataset (None is used for batch size, as it varies)
...
def cifar10_load_data():
    """
    Load the CIFAR-10 dataset and preprocess images for `DenseNet` architectures.
...
def cifar10_load_federated_data(num_clients, batch_size, num_steps_until_rtc_check, bias=None, seed=None):
    """
