...
#SBATCH --output=metrics/tmp/slurm_out/{job_name}_%a.out   # Stdout %j expands to jobId, %a is array task index
#SBATCH --error=metrics/tmp/slurm_out/{job_name}_%a.err   # Stderr %j expands to jobId, %a is array task index
